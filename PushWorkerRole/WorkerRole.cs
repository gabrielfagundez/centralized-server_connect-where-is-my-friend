...
namespace PushWorkerRole
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        public static String PLATAFORMA_PERMISO_IOS = "android_test";
        ...
        public override bool OnStart()
        {
            ...
            try
            {
                ...
                // REGISTRO APPLE
                byte[] certificado = new PushMiddleware().GetPermiso(PLATAFORMA_PERMISO_IOS);
